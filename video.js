...
(function() {
	...
	u.ec = function(a, c) {
		...
		u.Bb(d.z) && (delete d.z, delete d.T, delete d.disabled);
		u.Bb(d) && u.sc(a)
	};
	u.hc = function(a) {
		function c() {
	...
	u.getData = function(a) {
		var c = a[u.expando];
		c || (c = a[u.expando] = u.u++, u.pa[c] = {});
		return u.pa[c]
	};
	u.mc = function(a) {
		a = a[u.expando];
		return !(!a || u.Bb(u.pa[a]))
	};
	u.sc = function(a) {
		var c = a[u.expando];
		if (c) {
	...
	u.c = u.ka.extend({
		g: function(a, c, d) {
			...
			c = this.options(c);
			this.O = c.id || (c.el && c.el.id ? c.el.id : a.id() + "_component_" + u.u++);
			this.Vc = c.name || h;
			this.b = c.el || this.e();
			this.H = [];
			this.rb = {};
	...
	t = u.c.prototype;
	t.D = function() {
		if (this.H) for (var a = this.H.length - 1; 0 <= a; a--) this.H[a].D && this.H[a].D();
	...
	t.Y = function(a, c) {
		var d, e;
		"string" === typeof a ? (e = a, c = c || {}, d = c.componentClass || u.Z(e), c.name = e, d = new window.videojs[d](this.a || this, c)) : d = a;
		this.H.push(d);
		"function" === typeof d.id && (this.rb[d.id()] = d);
		(e = e || d.name && d.name()) && (this.S[e] = d);
		"function" === typeof d.el && d.el() && (this.qa || this.b).appendChild(d.el());
		return d
	};
	t.removeChild = function(a) {
		"string" === typeof a && (a = this.S[a]);
		if (a && this.H) {
			for (var c = l, d = this.H.length - 1; 0 <= d; d--) if (this.H[d] === a) {
				c = f;
				this.H.splice(d, 1);
				break
			}
	...
	function D(a, c, d, e) {
		...
		d = a.b.style[c];
		e = d.indexOf("px");
		return -1 !== e ? parseInt(d.slice(0, e), 10) : parseInt(a.b["offset" + u.Z(c)], 10)
	}
	u.o = u.c.extend({
		g: function(a, c) {
			u.c.call(this, a, c);
	...
	function E(a, c) {
		...
		j = g = d.offsetWidth;
		d = a.handle;
		if (a.f.pd) return j = e.top, e = c.changedTouches ? c.changedTouches[0].pageY : c.pageY, d && (d = d.r().offsetHeight, j += d / 2, g -= d), Math.max(0, Math.min(1, (j - e + g) / g));
		g = e.left;
	...
	t.Ja = function() {
		...
		if (this.J = this.sb()) for (var c = 0; c < this.J.length; c++) ca(a, this.J[c]);
		return a
	};
	t.sb = m();
	t.Q = function() {
	...
	t.ba = function(a) {
		a.preventDefault();
		32 == a.which || 13 == a.which ? this.na ? F(this) : G(this) : 27 == a.which && this.na && F(this)
	};
	...
	function G(a) {
		...
		a.J && 0 < a.J.length && a.J[0].r().focus()
	}
	function F(a) {
		a.na = l;
		a.ua.Ua();
	...
	t.e = function() {
		...
		if (c.hasChildNodes()) {
			...
			d = c.childNodes;
			e = d.length;
			for (k = []; e--;) g = d[e], j = g.nodeName.toLowerCase(), ("source" === j || "track" === j) && k.push(g);
	...
	function H(a, c, d) {
		a.h ? (a.aa = l, a.h.D(), a.Eb && (a.Eb = l, clearInterval(a.Qa)), a.Fb && I(a), a.h = l) : "Html5" !== c && a.F && (a.b.removeChild(a.F), a.F.player = h, a.F = h);
		a.ya = c;
		a.aa = l;
		var e = u.i.B({
			source: d,
	...
	t.buffered = function() {
		var a = J(this, "buffered"),
			c = this.s.mb = this.s.mb || 0;
		a && (0 < a.length && a.end(0) !== c) && (c = a.end(0), this.s.mb = c);
		return u.tb(0, c)
	};
	t.Ha = function() {
	...
	t.volume = function(a) {
		if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.s.volume = a, K(this, "setVolume", a), u.gd(a), this;
	...
	t.wa = function() {
		...
		a ? (u.d(document, a.vb, u.bind(this, function(c) {
			this.I = document[a.I];
			this.I === l && u.t(document, a.vb, arguments.callee);
			this.k("fullscreenchange")
		})), this.b[a.tc]()) : this.h.Sa() ? K(this, "enterFullScreen") : (this.Sc = f, this.Nc = document.documentElement.style.overflow, u.d(document, "keydown", u.bind(this, this.ic)), document.documentElement.style.overflow = "hidden", u.p(document.body, "vjs-full-window"), this.k("enterFullWindow"), this.k("fullscreenchange"));
		return this
	};
	t.pb = function() {
		var a = u.Ob.wa;
		this.I = l;
		if (a) document[a.ob]();
		else this.h.Sa() ? K(this, "exitFullScreen") : (L(this), this.k("fullscreenchange"));
		return this
	};
	t.ic = function(a) {
	...
	function L(a) {
		...
		document.documentElement.style.overflow = a.Nc;
	...
	t.src = function(a) {
		...
		Object ? window.videojs[this.ya].canPlaySource(a) ? this.src(a.src) : this.src([a]) : (this.s.src = a, this.aa ? (K(this, "src", a), "auto" == this.f.preload && this.load(), this.f.autoplay && this.play()) : this.P(function() {
			this.src(a)
		}));
		return this
	};
	...
	t.controls = function(a) {
		a !== b && this.Ia !== a && (this.Ia = !! a, this.k("controlschange"));
		return this.Ia
	};
	t.error = function() {
		return J(this, "error")
	...
	u.da = u.c.extend({
		g: function(a, c) {
			...
			a.R("play", u.bind(this, function() {
				var a, c = u.bind(this, this.$),
					g = u.bind(this, this.ta);
				this.$();
				"ontouchstart" in window || (this.a.d("mouseover", c), this.a.d("mouseout", g), this.a.d("pause", u.bind(this, this.pc)), this.a.d("play", u.bind(this, this.Ua)));
				a = l;
	...
	t.Aa = function() {
		...
		this.b.setAttribute("aria-valuetext", u.Ka(a, this.a.duration()))
	};
	t.yb = function() {
	...
	t.Hb = function(a) {
		a = E(this, a) * this.a.duration();
		a == this.a.duration() && (a -= 0.1);
		this.a.currentTime(a)
	};
	t.Ib = function(a) {
		u.M.prototype.Ib.call(this, a);
		this.a.Nb = l;
		this.qd && this.a.play()
	};
	t.wc = function() {
	...
	u.jb = u.c.extend({
		g: function(a, c) {
			u.c.call(this, a, c);
			a.h && (a.h.j && a.h.j.U === l) && this.p("vjs-hidden");
	...
	u.m = u.q.extend({
		g: function(a, c, d) {
			...
			this.d("click", this.n);
			for (a = u.m.$a.length - 1; 0 <= a; a--) u.d(this.b, u.m.$a[a], u.bind(this.a, this.Pc));
			this.Ta()
		}
	});
	t = u.m.prototype;
	...
	t.e = function() {
		var a = this.a,
			c = a.F;
		if (!c || this.j.Uc === l) c ? (c.player = h, a.F = h, a.r().removeChild(c), c = c.cloneNode(l)) : c = u.e("video", {
			id: a.id() + "_html5_api",
			className: "vjs-tech"
	...
	u.l = u.q.extend({
		g: function(a, c, d) {
			...
			d && (k.src = encodeURIComponent(u.kc(d.src)));
			u.zb(g, e);
			c.startTime && this.P(function() {
				this.load();
				this.play();
				this.currentTime(c.startTime)
			});
			if (c.iFrameMode === f && !u.Ac) {
				var s = u.e("iframe", {
					id: j + "_iframe",
					name: j + "_iframe",
					className: "vjs-tech",
	...
	u.l.nb = function(a) {
		if (a.type in u.l.Rc) return "maybe"
	};
	u.l.Rc = {
		"video/flv": "FLV",
		"video/x-flv": "FLV",
	...
	function V(a, c, d) {
		for (var e = a.za, g = 0, j = e.length, k, q; g < j; g++) k = e[g], k.id() === c ? (k.show(), q = k) : d && (k.K() == d && 0 < k.mode()) && k.disable();
		(c = q ? q.K() : d ? d : l) && a.k(c + "trackchange")
	}
	u.V = u.c.extend({
		g: function(a, c) {
			u.c.call(this, a, c);
			this.O = c.id || "vjs_" + c.kind + "_" + c.language + "_" + u.u++;
			this.uc = c.src;
			this.Lc = c["default"] || c.dflt;
			this.nd = c.title;
			this.yd = c.srclang;
			this.Tc = c.label;
			this.ha = [];
	...
	function W(a) {
		0 === a.ja && a.load();
		0 === a.ia && (a.a.d("timeupdate", u.bind(a, a.update, a.O)), a.a.d("ended", u.bind(a, a.reset, a.O)), ("captions" === a.A || "subtitles" === a.A) && a.a.S.textTrackDisplay.Y(a))
	}
	t.load = function() {
	...
	t.ad = function(a) {
		...
		for (var e = "", g = 1, j = a.length; g < j; g++) if (e = u.trim(a[g])) {
			-1 == e.indexOf("--\x3e") ? (c = e, e = u.trim(a[++g])) : c = this.ha.length;
			c = {
				id: c,
		...
		if (0 < this.ha.length) {
			...
			if (this.Lb === b || a < this.Lb || this.La <= a) {
				var c = this.ha,
					...
					j = [],
					k, q, n, s;
				a >= this.La || this.La === b ? s = this.wb !== b ? this.wb : 0 : (g = f, s = this.Db !== b ? this.Db : c.length - 1);
				for (;;) {
					n = c[s];
					if (n.sa <= a) e = Math.max(e, n.sa), n.Ga && (n.Ga = l);
					else if (a < n.startTime) {
						if (d = Math.min(d, n.startTime), n.Ga && (n.Ga = l), !g) break
					} else g ? (j.splice(0, 0, n), q === b && (q = s), k = s) : (j.push(n), k === b && (k = s), q = s), d = Math.min(d, n.sa), e = Math.max(e, n.startTime), n.Ga = f;
					if (g) if (0 === s) break;
					else s--;
	...
	u.X = u.L.extend({
		g: function(a, c) {
			...
			c.selected = d.ub();
			u.L.call(this, a, c);
			this.a.d(d.K() + "trackchange", u.bind(this, this.update))
		}
	});
	...
	u.cb.prototype.update = function() {
		for (var a = U(this.a), c = 0, d = a.length, e, g = f; c < d; c++) e = a[c], e.K() == this.ca.K() && 2 == e.mode() && (g = l);
		this.selected(g)
	};
	u.W = u.ea.extend({
		g: function(a, c) {
	...
	t.sb = function() {
		for (var a = [], c, d = 0; d < U(this.a).length; d++) c = U(this.a)[d], c.K() === this.A && a.push(new u.X(this.a, {
			track: c
		}));
		return a
	};
	t.Ja = function() {
		for (var a = U(this.a), c = 0, d = a.length, e, g, j = this.J = []; c < d; c++) if (e = a[c], e.K() == this.A && e.ub()) {
			if (2 > e.readyState()) {
				this.wd = e;
